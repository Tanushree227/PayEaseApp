    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        confirmButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dbHandler = new DBHandler(ToBankActivity.this);
                ...
                if(upiPin.equals(upi)) {
                    if (validateInput(accNumber, upiPin, ifscCode, accHolderName, amount)) {
                        ...
                        DBHandler dbHelper = new DBHandler(ToBankActivity.this);
                        ...
                        if (cursor.moveToFirst()) {
                            ...
                            if (balance1index >= 0) {
                                ...
                                if (cursor2 != null && cursor2.moveToFirst()) {
                                    ...
                                    if (balance1 >= transactionAmount) {
                                        ...
                                        Toast.makeText(ToBankActivity.this, "Insufficient balance for the transaction", Toast.LENGTH_SHORT).show();
                                    }
                                } else {
                                    Toast.makeText(ToBankActivity.this, "Invalid target bank account details", Toast.LENGTH_SHORT).show();
                                }
                            } else {
                            ...
                            Toast.makeText(ToBankActivity.this, "No bank account found for the logged-in user", Toast.LENGTH_SHORT).show();
                        }
                        db.close();
                    }
                }
